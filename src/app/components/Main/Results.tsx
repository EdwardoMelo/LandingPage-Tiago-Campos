...
const Results = () => {
  return (
    ...
    <div className='w-full h-full flex flex-col justify-around items-center'>
          ...
          <div className='results-container  w-[90%]'>
                { results.map((item, index) => (
                      <div key={index} className='result-card h-[600px] '>
                            ...
                            <div className='flex flex-col items-center gap-8 py-8'>
                                  <h1 className='result-card-title text-cyan-50 text-3xl uppercase font-semibold'>{item.title}</h1>
